...
public class TelaProdutoCopa extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitulo = new JLabel("☕ GERENCIAMENTO DE PRODUTOS DA COPA");
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Produtos");
        ...
        jButtonFiltrar = createSmallButton("Filtrar", new Color(241, 196, 15));
        filtroPanel.add(jButtonFiltrar, gbc);
        
        gbc.gridx = 2; gbc.gridwidth = 1; gbc.weightx = 0.5;
        jButtonBuscarTodos = createSmallButton("Buscar Todos", new Color(243, 156, 18));
        filtroPanel.add(jButtonBuscarTodos, gbc);
        
        String[] colunas = {"ID", "Descrição", "Valor", "Status"};
        ...
        jTableDados.setSelectionBackground(new Color(241, 196, 15));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Produto");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
        ...
        camposPanel.add(createLabel("* Valor (R$):"), gbc);
        
        gbc.gridx = 1; gbc.weightx = 0.3;
        DecimalFormat df = new DecimalFormat("#,##0.00");
        jFormattedTextFieldValor = new JFormattedTextField(df);
        jFormattedTextFieldValor.setPreferredSize(new Dimension(120, 30));
        camposPanel.add(jFormattedTextFieldValor, gbc);
        
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.gridwidth = 1; gbc.weightx = 0.0;
        gbc.anchor = GridBagConstraints.NORTH;
        camposPanel.add(createLabel("Observações:"), gbc);
        ...
        JScrollPane scrollObs = new JScrollPane(jTextAreaObs);
        scrollObs.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200)));
        camposPanel.add(scrollObs, gbc);
