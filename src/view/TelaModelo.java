...
public class TelaModelo extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitulo = new JLabel("🏷️ GERENCIAMENTO DE MODELOS");
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Modelos");
        ...
        gbc.gridwidth = 2;
        gbc.weightx = 0.5;
        jButtonFiltrar = createSmallButton("Filtrar", new Color(155, 89, 182));
        ...
        String[] colunas = {"ID", "Descrição", "Marca", "Status"};
        ...
        jTableDados.setSelectionBackground(new Color(155, 89, 182));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Modelo");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
        ...
        jComboBoxMarca.setPreferredSize(new Dimension(200, 30));
    ...
    public JComboBox<Marca> getjComboBoxMarca() {return jComboBoxMarca;}
