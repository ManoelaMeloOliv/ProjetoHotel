...
public class TelaHospede extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitulo = new JLabel("🏨 GERENCIAMENTO DE HÓSPEDES");
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Hóspedes");
        ...
        jCBFiltro = new JComboBox<>(new String[]{"ID", "Nome", "CPF"});
        jCBFiltro.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        jCBFiltro.setPreferredSize(new Dimension(100, 30));
        filtroPanel.add(jCBFiltro, gbc);
        
        gbc.gridx = 2; gbc.weightx = 0.75;
        jTFFiltro = new JTextField();
        jTFFiltro.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        jTFFiltro.setPreferredSize(new Dimension(200, 30));
        ...
        String[] colunas = {"ID", "Nome", "CPF", "Status"};
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Hóspede");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
    ...
    private JPanel createDadosPrincipaisPanel() {
        ...
        jTextFieldRg.setPreferredSize(new Dimension(130, 30));
    ...
    public JTextField getjTextFieldNomeFantasia() { return jTextFieldNome; }
