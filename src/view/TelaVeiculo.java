...
public class TelaVeiculo extends JPanel {
    ...
    private JComboBox<Marca> jComboBoxMarca;
    private JComboBox<Modelo> jComboBoxModelo;
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Veículos");
        ...
        gbc.gridx = 1;
        gbc.weightx = 0.35;
        jCBFiltro = new JComboBox<>(new String[]{"ID", "Placa", "Cor"});
        ...
        gbc.gridwidth = 2;
        gbc.weightx = 0.5;
        jButtonFiltrar = createSmallButton("Filtrar", new Color(46, 204, 113));
        ...
        String[] colunas = {"ID", "Placa", "Cor", "Marca", "Modelo", "Status"};
        ...
        jTableDados.setSelectionBackground(new Color(46, 204, 113));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Veículo");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
        ...
        gbc.gridy = row;
        gbc.weightx = 0.0;
        camposPanel.add(createLabel("* Placa:"), gbc);

        gbc.gridx = 1;
        gbc.gridwidth = 2;
        gbc.weightx = 1.0;
        jTextFieldPlaca = new JTextField();
        jTextFieldPlaca.setPreferredSize(new Dimension(300, 30));
        camposPanel.add(jTextFieldPlaca, gbc);
        ...
        gbc.gridwidth = 1;
        gbc.weightx = 0.0;
        camposPanel.add(createLabel("* Cor:"), gbc);

        gbc.gridx = 1;
        gbc.gridwidth = 2;
        gbc.weightx = 1.0;
        jTextFieldCor = new JTextField();
        jTextFieldCor.setPreferredSize(new Dimension(300, 30));
        camposPanel.add(jTextFieldCor, gbc);
        ...
        gbc.gridwidth = 1;
        gbc.weightx = 0.0;
        camposPanel.add(createLabel("* Marca:"), gbc);

        gbc.gridx = 1;
        gbc.gridwidth = 2;
        gbc.weightx = 1.0;
        jComboBoxMarca = new JComboBox<>();
        jComboBoxMarca.setPreferredSize(new Dimension(300, 30));
        jComboBoxMarca.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        camposPanel.add(jComboBoxMarca, gbc);
        ...
        gbc.gridwidth = 1;
        gbc.weightx = 0.0;
        camposPanel.add(createLabel("* Modelo:"), gbc);

        gbc.gridx = 1;
        gbc.gridwidth = 2;
        gbc.weightx = 1.0;
        jComboBoxModelo = new JComboBox<>();
        jComboBoxModelo.setPreferredSize(new Dimension(300, 30));
        jComboBoxModelo.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        camposPanel.add(jComboBoxModelo, gbc);
        ...
        jComboBoxStatus.setFont(new Font("Segoe UI", Font.PLAIN, 12));
    ...
    private void setupRenderers() {
        jComboBoxMarca.setRenderer(new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(JList<?> list, Object value,
                ...
                if (value instanceof Marca) {
                    setText(((Marca) value).getDescricao());
                }
                return this;
            }
        });

        jComboBoxModelo.setRenderer(new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(JList<?> list, Object value,
                    int index, boolean isSelected, boolean cellHasFocus) {
                super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                ...
                if (value instanceof Modelo) {
                    setText(((Modelo) value).getDescricao());
                }
                return this;
            }
        });
    ...
    public JButton getjButtonBuscarTodos() {
        return jButtonBuscarTodos;
    }
