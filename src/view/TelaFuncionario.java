...
public class TelaFuncionario extends JPanel {
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Funcionários");
        ...
        jCBFiltro = new JComboBox<>(new String[]{"ID", "Nome", "Usuário"});
        ...
        jTFFiltro.setPreferredSize(new Dimension(180, 30));
        filtroPanel.add(jTFFiltro, gbc);
        
 
        gbc.gridx = 0; gbc.gridy = 1; gbc.gridwidth = 2; gbc.weightx = 0.5;
        jButtonFiltrar = createSmallButton("Filtrar", new Color(41, 128, 185));
        filtroPanel.add(jButtonFiltrar, gbc);
        
        gbc.gridx = 2; gbc.gridwidth = 1; gbc.weightx = 0.5;
        jButtonBuscarTodos = createSmallButton("Buscar Todos", new Color(142, 68, 173));
        filtroPanel.add(jButtonBuscarTodos, gbc);
        
        String[] colunas = {"ID", "Nome", "Usuário", "Status"};
        ...
        jTableDados.setSelectionBackground(new Color(41, 128, 185));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Funcionário");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
    ...
    private JPanel createDadosPrincipaisPanel() {
        ...
        jTextFieldNome.setPreferredSize(new Dimension(200, 30));
        ...
        jTextFieldUsuario.setPreferredSize(new Dimension(150, 30));
        panel.add(jTextFieldUsuario, gbc);
        
        gbc.gridx = 2; gbc.weightx = 0.0;
        panel.add(createLabel("* Senha:"), gbc);
        gbc.gridx = 3; gbc.weightx = 0.5;
        jPasswordFieldSenha = new JPasswordField();
        jPasswordFieldSenha.setPreferredSize(new Dimension(150, 30));
        panel.add(jPasswordFieldSenha, gbc);
        ...
        jTextFieldRg.setPreferredSize(new Dimension(120, 30));
    ...
    private JPanel createEnderecoPanel() {
        ...
        jTextFieldLogradouro.setPreferredSize(new Dimension(200, 30));
        ...
        jTextFieldComplemento.setPreferredSize(new Dimension(200, 30));
    ...
    private JPanel createBotoesPanel() {
        ...
        jButtonNovo = createButton("Novo", new Color(41, 128, 185));
        jButtonNovo.setActionCommand("0");
        
        jButtonCancelar = createButton("Cancelar", new Color(149, 165, 166));
        jButtonCancelar.setActionCommand("1");
        
        jButtonGravar = createButton("Gravar", new Color(39, 174, 96));
        jButtonGravar.setActionCommand("1");
        
        jButtonSair = createButton("Sair", new Color(192, 57, 43));
    ...
    public JTextField getjTextFieldUsuario() { return jTextFieldUsuario; }
    public JPasswordField getjPasswordFieldSenha() { return jPasswordFieldSenha; }
