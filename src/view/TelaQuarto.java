...
public class TelaQuarto extends JPanel {
    ...
    private JTextField jTextFieldIdentificacao;
    private JTextField jTextFieldAndar;
    private JCheckBox jCheckBoxAnimais;
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitulo = new JLabel("🛏️ GERENCIAMENTO DE QUARTOS");
    ...
    private JPanel createBuscaPanel() {
        ...
        JLabel lblTitulo = new JLabel("🔍 Buscar Quartos");
        ...
        jCBFiltro = new JComboBox<>(new String[]{"ID", "Descrição", "Identificação"});
        jCBFiltro.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        jCBFiltro.setPreferredSize(new Dimension(130, 30));
        ...
        jButtonFiltrar = createSmallButton("Filtrar", new Color(52, 152, 219));
        filtroPanel.add(jButtonFiltrar, gbc);
        
        gbc.gridx = 2; gbc.gridwidth = 1; gbc.weightx = 0.5;
        jButtonBuscarTodos = createSmallButton("Buscar Todos", new Color(155, 89, 182));
        filtroPanel.add(jButtonBuscarTodos, gbc);
        
        String[] colunas = {"ID", "Identificação", "Descrição", "Andar", "Status"};
        ...
        jTableDados.setSelectionBackground(new Color(52, 152, 219));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📝 Dados do Quarto");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
    ...
    private JPanel createDadosPrincipaisPanel() {
        ...
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.weightx = 0.0;
        panel.add(createLabel("* Identificação:"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.3;
        jTextFieldIdentificacao = new JTextField();
        jTextFieldIdentificacao.setPreferredSize(new Dimension(150, 30));
        panel.add(jTextFieldIdentificacao, gbc);
        ...
        panel.add(jTextFieldDescricao, gbc);
        
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.gridwidth = 1; gbc.weightx = 0.0;
        panel.add(createLabel("* Capacidade:"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.3;
        jTextFieldCapacidade = new JTextField();
        jTextFieldCapacidade.setPreferredSize(new Dimension(100, 30));
        panel.add(jTextFieldCapacidade, gbc);
        
        gbc.gridx = 2; gbc.weightx = 0.0;
        panel.add(createLabel("Metragem (m²):"), gbc);
        gbc.gridx = 3; gbc.weightx = 0.3;
        jTextFieldMetragem = new JTextField();
        jTextFieldMetragem.setPreferredSize(new Dimension(100, 30));
        panel.add(jTextFieldMetragem, gbc);
        
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.weightx = 0.0;
        panel.add(createLabel("* Andar:"), gbc);
        gbc.gridx = 1; gbc.weightx = 0.3;
        jTextFieldAndar = new JTextField();
        jTextFieldAndar.setPreferredSize(new Dimension(100, 30));
        panel.add(jTextFieldAndar, gbc);
        
        row++;
        gbc.gridx = 0; gbc.gridy = row; gbc.weightx = 0.0;
        panel.add(createLabel("Aceita Animais:"), gbc);
        gbc.gridx = 1; gbc.gridwidth = 3; gbc.weightx = 1.0;
        jCheckBoxAnimais = new JCheckBox("Sim, este quarto aceita animais de estimação");
        jCheckBoxAnimais.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        jCheckBoxAnimais.setBackground(Color.WHITE);
        panel.add(jCheckBoxAnimais, gbc);
    ...
    public JCheckBox getjCheckBoxAnimais() { return jCheckBoxAnimais; }
