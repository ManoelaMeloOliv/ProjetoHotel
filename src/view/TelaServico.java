...
public class TelaServico extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitulo = new JLabel("🍽️ GERENCIAMENTO DE SERVIÇOS");
    ...
    private JPanel createBuscaPanel() {
        ...
        jButtonFiltrar = createSmallButton("Filtrar", new Color(231, 76, 60));
        filtroPanel.add(jButtonFiltrar, gbc);
        
        gbc.gridx = 2; gbc.gridwidth = 1; gbc.weightx = 0.5;
        jButtonBuscarTodos = createSmallButton("Buscar Todos", new Color(192, 57, 43));
        ...
        jTableDados.setSelectionBackground(new Color(231, 76, 60));
    ...
    private JPanel createFormularioPanel() {
        ...
        JLabel lblTitulo = new JLabel("📋 Dados do Serviço");
        lblTitulo.setFont(new Font("Segoe UI Emoji", Font.BOLD, 18));
        lblTitulo.setForeground(new Color(52, 73, 94));
        lblTitulo.setBorder(new EmptyBorder(0, 0, 15, 0));
